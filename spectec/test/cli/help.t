...
eval shares this exact set:
  ...
  === flags ===
    ...
    [--color WHEN]             . colorize diagnostics: auto|always|never (default:
                                 auto)
    [--dep-pos.level LEVEL]    . verbosity level (e.g., summary|full)
    [--dep-pos.output FILE]    . output destination file
    [--dep-pos.targets UIDS]   . comma-separated premise UIDs to analyze
    [--dep-pos.targets-file FILE]
                               . premise UIDs, one per line
