...
def main():
    # Usage: python AttesterSlashingSSZToJson.py --in /path/to/attester_slashing_input.ssz --out /path/to/attester_slashing_output.json

    p = argparse.ArgumentParser(description="Convert AttesterSlashing SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="AttesterSlashing", help="Type name inside the module (default: AttesterSlashing)")
