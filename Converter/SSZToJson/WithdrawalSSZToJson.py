...
def main():
    # Usage: python WithdrawalSSZToJson.py --in /path/to/withdrawal_input.ssz --out /path/to/withdrawal_output.json

    p = argparse.ArgumentParser(description="Convert Withdrawal Input SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="ExecutionPayload", help="Type name inside the module (default: Withdrawal)")
