...
def main():
    # Usage: python BeaconBlockHeaderSSZToJson.py --in /path/to/beacon_block_header_input.ssz --out /path/to/beacon_block_header_output.json

    p = argparse.ArgumentParser(description="Convert BeaconBlockHeader Input SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="BeaconBlock", help="Type name inside the module (default: BeaconBlockHeader)")
