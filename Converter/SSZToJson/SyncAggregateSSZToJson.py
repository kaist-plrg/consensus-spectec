...
def main():
    # Usage: python SyncAggregateSSZToJson.py --in /path/to/sync_aggregate_input.ssz --out /path/to/sync_aggregate_output.json

    p = argparse.ArgumentParser(description="Convert SyncAggregate SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="SyncAggregate", help="Type name inside the module (default: SyncAggregate)")
