...
def main():
    # Usage: python AttestationSSZToJson.py --in /path/to/attestation_input.ssz --out /path/to/attestation_output.json

    p = argparse.ArgumentParser(description="Convert Attestation SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="Attestation", help="Type name inside the module (default: Attestation)")
