...
def main():
    # Usage: python ProposerSlashingSSZToJson.py --in /path/to/proposer_slashing_input.ssz --out /path/to/proposer_slashing_output.json

    p = argparse.ArgumentParser(description="Convert ProposerSlashing SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="ProposerSlashing", help="Type name inside the module (default: ProposerSlashing)")
