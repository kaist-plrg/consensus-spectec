...
def main():
    # Usage: python VoluntaryExitSSZToJson.py --in /path/to/voluntary_exit_input.ssz --out /path/to/voluntary_exit_output.json

    p = argparse.ArgumentParser(description="Convert SignedVoluntaryExit SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="SignedVoluntaryExit", help="Type name inside the module (default: SignedVoluntaryExit)")
