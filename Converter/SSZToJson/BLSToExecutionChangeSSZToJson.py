...
def main():
    # Usage: python BLSToExecutionChangeSSZToJson.py --in /path/to/bls_to_execution_change_input.ssz --out /path/to/bls_to_execution_change_output.json

    p = argparse.ArgumentParser(description="Convert SignedBLSToExecutionChange SSZ to JSON using remerkleable types.")
    ...
    p.add_argument("--type", dest="type_name", default="SignedBLSToExecutionChange", help="Type name inside the module (default: SignedBLSToExecutionChange)")
